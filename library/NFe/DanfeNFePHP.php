...
//classe principal
class NFe_DanfeNFePHP extends CommonNFePHP implements DocumentoNFePHP
{
    //publicas
    ...
    */
    ...
    protected function __rodapeDANFE($x,$y){
        ...
        $texto = "SysAdmin DANFE ver. " . $this->version .  "  Powered by Cepheros (GNU/GPLv3 GNU/LGPLv3) © www.32dll.com.br";
        $aFont = array('font'=>$this->fontePadrao,'size'=>6,'style'=>'I');
        //$this->__textBox($x, $y, $w, $h, $text, $aFont, $vAlign, $hAlign, $border, $link, $force, $hmax, $hini)
        $this->__textBox($x,$y,$w,4,$texto,$aFont,'T','R',0,'http://www.32dll.com.br');
    } //fim __rodapeDANFE
