<?php
class Crm_Model_Prospects_FontesPropostas extends Zend_Db_Table_Abstract{
	protected $_name = 'tblapoio_prospects_fontespropostas';
	...
	public static function getRegistroPadrao(){
		$db = new Crm_Model_Prospects_FontesPropostas();
