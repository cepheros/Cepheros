...
class Erp_Model_Financeiro_LancamentosRecebimentos extends Zend_Db_Table_Abstract{

	protected $_name = 'tblrecebimentos_lancamentos';
	...
	public static function getAllDataLanc($id){
		...
		->from(array('a'=>'tblrecebimentos_lancamentos'),array('a.id_registro','a.id_lancamento','a.datavencimento','a.valororiginal','a.numeroparcela','a.quantidadeparcelas','a.tipodocumento','a.data_sysbaixa','a.user_sysbaixa','a.databaixa',
				...
				'b.id_pessoa','b.id_empresa','b.nomelancamento','b.numerodocumento','c.nomefantasia as empresa','d.razaosocial','e.nomedocumento','f.nomebanco','g.nomesubcategoria'))
	...
	public static function getValoresRecebimentoMes($mes,$ano,$statusl){
		$dados = new Erp_Model_Financeiro_LancamentosRecebimentos();
	...
	public static function getValoresRecebimentoMesRealizado($mes,$ano,$statusl){
		$dados = new Erp_Model_Financeiro_LancamentosRecebimentos();
