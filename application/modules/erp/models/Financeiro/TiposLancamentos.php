...
class Erp_Model_Financeiro_TiposLancamentos extends Zend_Db_Table_Abstract{
	
	protected $_name = 'tblfinanceiro_subcategorias';
	protected $_primary = 'id_registro';
	
	public static function getCombo(){
		$db = new Erp_Model_Financeiro_TiposLancamentos();
	...
	public static function getDataCategora($id = null){
		$db = new Erp_Model_Financeiro_TiposLancamentos();
		if($id){
			$dados = $db->fetchAll("id_categoria = '$id'")->toArray();
		}else{
			$dados = $db->fetchAll()->toArray();
		}
		foreach($dados as $depto){
