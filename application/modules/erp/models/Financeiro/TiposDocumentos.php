...
class Erp_Model_Financeiro_TiposDocumentos extends Zend_Db_Table_Abstract{

	protected $_name = 'tblapoio_tiposdocumentos';
	...
	public static function renderCombo(){
		...
		foreach($dados as $depto){
			$rdepto[$depto['id_registro']] = $depto['nomedocumento'];
		}
		return $rdepto;
	}
