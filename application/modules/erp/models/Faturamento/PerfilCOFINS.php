...
class Erp_Model_Faturamento_PerfilCOFINS extends Zend_Db_Table_Abstract{
	
	protected $_name = 'tblperfilfaturamento_cofins';
	protected $_primary = 'id_registro';
	
	public static function getPerfil($id){
		$db = new Erp_Model_Faturamento_PerfilCOFINS;
		$dados = $db->fetchRow("id_perfil = '$id'");
		return $dados;
	}
}