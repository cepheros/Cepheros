...
class Dashboard_IndexController extends Zend_Controller_Action{
	...
	$cedente = new OpenBoleto\Agente('Empresa de cosméticos LTDA', '02.123.123/0001-11', 'CLS 403 Lj 23', '71000-000', 'Brasília', 'DF');

	$boleto = new OpenBoleto\Banco\BancoDoBrasil(array(
